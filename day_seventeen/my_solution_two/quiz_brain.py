class QuizBrain:
    ...
    def next_question(self):
        selected_answer = input(f"Q.{self.question_number + 1}: {self.question_list[self.question_number].text} (True/False)?: ")
        correct_answer = self.question_list[self.question_number].answer
        self.check_answer(user_answer=selected_answer, correct_answer=correct_answer)
